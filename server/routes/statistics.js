    ...
    try {
        ...
        if (currentYear !== collectionYear) {
            ...
            if (!insertResult.insertedId) {
                throw new Error("Error al mover el documento a la colección correspondiente. 01");
            }
            ...
            if (!deleteResult.deletedCount) {
                throw new Error("Error al mover el documento a la colección correspondiente. 02");
            }
